...
lcFromImage="registry:5000/ubuntu:20.04"
...
run DEBIAN_FRONTEND=noninteractive \
  ...
  && apt-get install --no-install-recommends -y netbase nfs-common dbus /libntirpc3_3.5-ubuntu1~focal1_armhf.deb /nfs-ganesha_3.5-ubuntu1~focal3_armhf.deb /nfs-ganesha-vfs_3.5-ubuntu1~focal3_armhf.deb \
  && apt-get clean \
  && rm -f /libntirpc3_3.5-ubuntu1~focal1_armhf.deb /nfs-ganesha_3.5-ubuntu1~focal3_armhf.deb /nfs-ganesha-vfs_3.5-ubuntu1~focal3_armhf.deb \
