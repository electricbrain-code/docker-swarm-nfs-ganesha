...
lcFromImage="docker.io/amd64/ubuntu:20.04"
...
run DEBIAN_FRONTEND=noninteractive \
  ...
  && apt-get install --no-install-recommends -y netbase nfs-common dbus /libntirpc3_3.5-ubuntu1~focal1_amd64.deb /nfs-ganesha_3.5-ubuntu1~focal3_amd64.deb /nfs-ganesha-vfs_3.5-ubuntu1~focal3_amd64.deb \
  && apt-get clean \
  && rm -f /libntirpc3_3.5-ubuntu1~focal1_amd64.deb /nfs-ganesha_3.5-ubuntu1~focal3_amd64.deb /nfs-ganesha-vfs_3.5-ubuntu1~focal3_amd64.deb \
